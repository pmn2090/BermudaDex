                ...
                <div className="text-center hero-content">
                    <div>
                        ...
                        <div className="max-w-md">
                            <p className="mb-5">
                            Building a privacy-enabled DEX on Solana
                            </p>
                            <p className="mb-5">Bermuda leverages the existing ecosystem primitives in order to deliver a privacy-enabled exchange. </p>
